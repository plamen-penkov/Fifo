class fifo_directed_test_2 extends fifo_base_test;
    `uvm_component_utils(fifo_directed_test_2)

    function new(string name = "fifo_directed_test_2", uvm_component parent);
